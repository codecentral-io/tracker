...
class DisplaySettingsForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
class PoloniexSettingsForm extends Component {
  render() {
    return (
  ...
  render() {
    return (
      <Fragment>
        ...
        <DisplaySettingsForm units={this.props.units} updateUnits={this.props.updateUnits} />
        <div className="h4 text-center my-3">Poloniex Settings</div>
        <PoloniexSettingsForm />
      </Fragment>
    );
  }
}
